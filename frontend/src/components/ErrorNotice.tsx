...
export const ErrorNotice: React.FC<ErrorNoticeProps> = ({ messageKey, isCritical = false, onClose }) => {
    ...
    return (
        <div className="alert alert-danger shadow-sm d-flex align-items-center justify-content-between p-3 mb-3 rounded-3 border-danger-subtle fade show" role="alert">
